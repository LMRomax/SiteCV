				...
				if (rsFormCaptcha === true) {
					...
					$.post( rsFormAction,
						...
						function (response) {
							...
							if(data){
								rsForm.append('<div class="rsFormResponce"><strong>Votre message a bien Ã©tÃ© envoyÃ© !</strong><br>Vous recevrez une rÃ©ponse dans les plus brefs dÃ©lais.</div>');
							} else {
								rsForm.append('<div class="rsFormResponce"><strong>Une erreur est survenue durant l\'envoi de votre message.</strong><br>Veuillez rÃ©essayer ultÃ©rieurement ou envoyer votre message Ã  contact@fboris.com</div>');
							}
						}
					);
					return false;
